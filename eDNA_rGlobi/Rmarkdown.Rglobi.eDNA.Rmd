...
for(i in 1:number_eDNA_spp)
{
  ...
  if(taxonomy_only_table[i,genus_species_column_number] == "" ||  is.null(taxonomy_only_table[i,genus_species_column_number])) #no genus-species value
    {
