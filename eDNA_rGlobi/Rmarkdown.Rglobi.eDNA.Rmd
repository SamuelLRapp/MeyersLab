...
species_column_number <- which(colnames(taxonomy_only_table)=="species")
...
colnames(BinaryMatrix)[1:number_eDNA_spp]<-taxonomy_only_table[,species_column_number]
rownames(BinaryMatrix)[1:number_eDNA_spp]<-taxonomy_only_table[,species_column_number]
#matrix to hold interaction value 
InteractionMatrix <-matrix(NA, number_eDNA_spp,number_eDNA_spp)
colnames(InteractionMatrix)[1:number_eDNA_spp]<-taxonomy_only_table[,species_column_number]
rownames(InteractionMatrix)[1:number_eDNA_spp]<-taxonomy_only_table[,species_column_number]
```
...
for(i in 1:number_eDNA_spp)
{
  ...
  source_species <- paste(taxonomy_only_table[i,genus_column_number], taxonomy_only_table[i,species_column_number], sep=" ")
  target_species <-paste(taxonomy_only_table[j,genus_column_number], taxonomy_only_table[j,species_column_number],sep=" ")
